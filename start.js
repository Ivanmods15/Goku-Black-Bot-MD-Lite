...
mobile: MethodMobile, 
browser: opcion == '1' ? ['GokuBlackBot', 'Edge', '2.0.0'] : methodCodeQR ? ['GokuBlackBot', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
console.log('🚩 GokuBlackBot no tiene Sub-Bots vinculados.');
return;
}
