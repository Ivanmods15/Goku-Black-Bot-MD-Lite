...
await conn.sendButton(m.chat, wm, texto1, yt_play[0].thumbnail, [['Menu 🌀', `${usedPrefix}menu`],['Audio 🪨',`${usedPrefix}play ${yt_play[0].url}`],['Video 🫧',`${usedPrefix}plays2 ${yt_play[0].url}`]], null, null, fgif2)
} catch (e) {
