...
let folderSub = `./BlackJadiBot/${serbotFolder}`
...
browser: ['GokuBlack Sub-Bot', 'Edge', '2.0.0'],
auth: {
creds: state.creds,
...
fs.rmdirSync(`./BlackJadiBot/${serbotFolder}`, { recursive: true })
}
}, 30000)
